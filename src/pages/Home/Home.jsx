...
<section className="service-flow py-lg-12 py-5 text-white">
  <div className="container">
    {categories[0] && (
      <div className="mb-12">
        {/* 標題 */}
        <h2 className="section-title fw-bold display-6 mb-lg-3 mb-2">
        ...
        {/* 圖片與名稱 */}
        <div className="row row-cols-lg-5 row-cols-md-1 row-cols-1 gy-4">
        ...
        {bestSolutions[0].subtitle && (
          <p className="text-center mb-lg-8 mb-5">
            {typeof bestSolutions[0].subtitle === "object"
              ? bestSolutions[0].subtitle[lang] || bestSolutions[0].subtitle["zh-TW"]
              : bestSolutions[0].subtitle}
          </p>
        )}
